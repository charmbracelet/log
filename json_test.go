...
func TestJson(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:     "struct field",
			expected: "{\"lvl\":\"info\",\"msg\":\"info\",\"struct\":\"{foo:bar}\"}\n",
			msg:      "info",
		...
		},
		{
			...
			expected: "{\"lvl\":\"info\",\"msg\":\"info\",\"slice\":\"[{foo:bar} {foo:baz}]\"}\n",
			msg:      "info",
		...
		},
		{
			...
			expected: "{\"lvl\":\"info\",\"msg\":\"info\",\"slice\":\"[error message1 error message2]\"}\n",
			msg:      "info",
		...
		{
			name:     "map of strings",
			expected: "{\"lvl\":\"info\",\"map\":\"map[a:b foo:bar]\",\"msg\":\"info\"}\n",
			msg:      "info",
